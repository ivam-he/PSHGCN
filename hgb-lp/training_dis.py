...
def training(args):
    ...
    for k in res_2hop:
        res_2hop[k] /= total
    print("Run:",args.seed, "Result:", res_2hop)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--decode', type=str, default='distmult')
    ...
    parser.add_argument("--input_drop", type=float, default=0.4)
    parser.add_argument('--dropout', type=float, default=0.1)
    parser.add_argument("--K", type=int, default=3)
    parser.add_argument("--lr", type=float, default=0.006)
    parser.add_argument("--wd", type=float, default=5e-5)
    parser.add_argument("--prop_lr", type=float, default=0.008)
    parser.add_argument("--prop_wd", type=float, default=0.001)
